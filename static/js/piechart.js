d3.json('/api/allaccidents').then( response => {
    console.log(response);
    const weatherType = response.map(object => object.Weather_Condition);
    ...
    function foo(arr) {
        ...
        var newArray = [];
        var ColumnName = ['Weather_Condition', 'Occurance'];
        for(let i=0; i<cityName.length; i=i+2) {
            var result = cityName.reduce(function(result, field, index) {
                result[ColumnName[index]] = field;
                // cityName.shift();
                return result;
              }, {})
            // console.log(result);
        ...
        // cityName.forEach(key => {
        //     console.log(key);
        //     var thisObjectWeatherCondition = key;
        //     cityName[key] = cityCount[i]);
        //     result.Occurance = cityCount[key]ame.forEach((key, i) => res
        // })
        // console.log(result);
...
​
        ...
        //     var thisObjectAsArray = object.split(':');
        //     console.log(Object.keys(object));
        //     object.forEach(key => {
        //     newObject.Weather_Condition = Object.keys(key);
        //     newObject.Occurance = Object.value(key);
        //     });
    ...
    //       'Occurance': ''
    //     };
    //     // console.log(thisObjectAsArray);
    //     thisObjectAsArray.forEach(function(element,index,array) {
    //         if(index===0) {
    //            newObject.Weather_Condition = element[0];
    //         } else if(index===1) {
    //            newObject.Occurance = element[0];
    //         }
    //     });
    //     newArray.push(newObject);
    //   }
